...
const ProjectsItemsReverse = ({
  ...
  const pr_item_viewPort = InViewport(pr_item, 0.2);
  return (
    <div ref={pr_item}>
      <div
        className={`flex flex-col-reverse md:flex-row justify-center gap-6 `}
      >
...
export default ProjectsItemsReverse;
